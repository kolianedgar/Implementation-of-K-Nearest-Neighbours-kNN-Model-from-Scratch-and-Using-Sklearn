...
test_own <- c(
  0.004998445510864258, 0.007002353668212891, 0.15515923500061035,
  0.016039133071899414, 1.2124135494232178, 0.005000591278076172
)
...
test_package <- c(
  0.008033514022827148, 0.00618743896484375, 0.01703953742980957,
  0.008002042770385742, 0.17426276206970215, 0.01615285873413086
)
