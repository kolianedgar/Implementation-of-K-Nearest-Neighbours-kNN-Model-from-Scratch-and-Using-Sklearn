...
# Load results
# -------------------------------------------------
df_own <- read.csv("knn_own_results_zoo_70_30.csv", stringsAsFactors = FALSE)
df_package <- read.csv("sklearn_knn_zoo_70_30.csv", stringsAsFactors = FALSE)
...
write.csv(
  results_df,
  file = "results/knn_mc_permuation_memory_zoo_70_30.csv",
  row.names = FALSE
)
