...
# Load results
# -------------------------------------------------
df_own <- read.csv("knn_own_results_mushroom_80_20.csv", stringsAsFactors = FALSE)
df_package <- read.csv("sklearn_knn_mushroom_80_20.csv", stringsAsFactors = FALSE)
...
write.csv(
  results_df,
  file = "results/knn_mc_permuation_memory_mushroom_80_20.csv",
  row.names = FALSE
)
